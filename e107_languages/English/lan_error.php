...
define("LAN_ERROR_30", "[6]: Unable to form a valid connection to mySQL. Please check that your configuration file contains the correct information.");
...
define("LAN_ERROR_32", "To complete the upgrade, copy the following text into your configuration file:");
